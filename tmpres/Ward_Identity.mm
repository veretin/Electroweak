   ...
   G02 = (
      ...
      *mmb*xiZ
      ...
      xiW
       ...
       + 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       - 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*d*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       + DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*d*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       + 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*d*LOOP^2*em^3
       - 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       + 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*d*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       - DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*d*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       - 1/2*DIA[13]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*d*LOOP^2*em^3
       ...
       - 3/4*DIA[14]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[14]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[14]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - DIA[14]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       + 3/4*DIA[14]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[14]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[14]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + DIA[14]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       ...
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 3/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*xiZ^2
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*xiZ
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 5/4*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*d*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       - 9/8*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       + DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*c^(-2)
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 3/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*xiZ^2
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*xiZ
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 5/4*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*d*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       + 9/8*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       - DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       - 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*c^(-2)
       + 1/2*DIA[15]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3
       ...
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)*s^2
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       - 1/2*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2
       + 1/2*DIA[16]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*mmW^(-1)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*mmW^(-1)
       - 1/4*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*s^2*mmW^(-1)
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)*s^2
       + 1/8*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       + 1/2*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2
       - 1/2*DIA[16]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       ...
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       - 3/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       + 3/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/2*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH^2
       + 3/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*
      mmH
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       - 1/2*DIA[17]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 3/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 3/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/2*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       - 3/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       + 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)
       + 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/4*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       + 1/2*DIA[17]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       ...
       - 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       + 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       + 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH^2
       - 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*
      mmH
       + 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       + 1/8*DIA[18]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       ...
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)
      *mmb
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)
      *mmt
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb^2
       + 1/2*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt*mmb
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt^2
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*
      mmb
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*
      mmt
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmb
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmb
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmb
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb^2
       - 1/2*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt*
      mmb
       + 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt^2
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*mmb
       - 1/4*DIA[19]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*mmt
       ...
       + 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       - 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[20]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       ...
       + 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       + 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       - 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       + 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*xiZ
       - 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       - 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       + 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       - 1/8*DIA[21]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*xiZ
       ...
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       + 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       - 1/8*DIA[22]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)
       ...
       - 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       + 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*d*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       - DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*d*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       - 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*d*LOOP^2*em^3
       + 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       - 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-2)
       - 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,0,1]*d*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,-1]*LOOP^2*em^3*mmW^(-2)
       + DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,0]*d*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       + 1/2*DIA[23]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,0,1]*d*LOOP^2*em^3
       ...
       + 3/4*DIA[24]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[24]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[24]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + DIA[24]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       - 3/4*DIA[24]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[24]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[24]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - DIA[24]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       ...
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 3/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*xiZ^2
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*xiZ
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 5/4*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*d*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       + 9/8*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       - DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*c^(-2)
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       + 3/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,0]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*xiZ^2
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*xiZ
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*mmW^(-2)
       - 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,-1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*mmW^(-1)
       - 5/4*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-1)
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,0]*d*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)
       - 9/8*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       + DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       + 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3*c^(-2)
       - 1/2*DIA[25]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW,1]*den[k1 - k2,mmZ,1]*d*LOOP^2*em^3
       ...
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)*s^2
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       + 1/2*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2
       - 1/2*DIA[26]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*mmW^(-1)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,-1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*c^(-2)*s^2*
      mmW^(-1)*xiZ
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ*xiZ,1]*LOOP^2*em^3*mmW^(-1)*xiZ
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*s^2*mmW^(-2)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^2*mmW^(-2)
       - 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2*mmW^(-1)
       + 1/4*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*c^(-2)*s^2*mmW^(-1)
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-4)*s^2
       - 1/8*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)
       - 1/2*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3*c^(-2)*s^2
       + 1/2*DIA[26]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmZ,1]*LOOP^2*em^3
       ...
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       + 3/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       - 3/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/2*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH^2
       - 3/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*
      mmH
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       + 1/2*DIA[27]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,-2]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 3/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,-1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 3/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/2*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,0]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       + 3/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       - 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW*xiW,1]*LOOP^2*em^3*s^(-2)
       - 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/4*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)
       + 1/8*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       - 1/2*DIA[27]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmH,1]*den[k1 - k2,mmW,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       ...
       + 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       - 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH
       - 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*
      mmH^2
       + 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*
      mmH
       - 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,0]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,0]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH
       + 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-2)*mmH^2
       - 1/8*DIA[28]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmW*xiW,1]*den[k1 - k2,mmH,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*mmH
       ...
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)
      *mmb
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)
      *mmt
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb^2
       - 1/2*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt*mmb
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt^2
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*
      mmb
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*
      mmt
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmb
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmb
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,0]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmb
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,0]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmb^2
       + 1/2*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*mmt*
      mmb
       - 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-2)*
      mmt^2
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*mmb
       + 1/4*DIA[29]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,mmb,1]*den[k1 - k2,mmt,1]*LOOP^2*em^3*s^(-2)*Nc*TB*mmW^(-1)*mmt
       ...
       - 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       + 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/4*DIA[30]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       ...
       - 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       - 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       + 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       - 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*xiZ
       + 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       + 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       - 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*s^(-2)*mmW^(-1)*xiZ
       + 1/8*DIA[31]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*s^(-2)*xiZ
       ...
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW*xiW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,-1]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*mmW^(-1)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,0]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*mmW^(-1)
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,0]*LOOP^2*em^3*c^2*s^(-2)*mmW^(-1)
       - 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3
       + 1/8*DIA[32]*inv[1 - xiW]*den[k1,mmW,0]*den[k2,0,1]*den[k1 - k2,0,1]*LOOP^2*em^3*c^2*s^(-2)
